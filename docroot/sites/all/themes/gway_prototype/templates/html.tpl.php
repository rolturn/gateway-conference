...
<!--  <meta name="viewport" content="width=device-width,initial-scale=1">-->
  ...
  <title><?php print $head_title; ?></title>
	<noscript>
		<link type="text/css" rel="stylesheet" href="<?php print base_path().drupal_get_path('theme', 'gway_prototype'); ?>/css/adapt_18/mobile.css" />
	</noscript>
	<script type="text/javascript">
		// Edit to suit your needs.
		var ADAPT_CONFIG = {
		  // Where is your CSS?
		  path: '<?php print base_path().drupal_get_path('theme', 'gway_prototype'); ?>/css/adapt_18/',
