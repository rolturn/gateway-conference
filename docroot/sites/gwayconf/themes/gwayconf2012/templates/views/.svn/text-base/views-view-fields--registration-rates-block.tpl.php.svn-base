...
<?php if ((!empty($row->field_field_registrations_cost[0]['rendered'])) || (!empty($row->field_field_registrations_link[0]['rendered']))): ?>
...
<?php if ((!empty($row->field_field_registrations_early_cost[0]['rendered'])) || (!empty($row->field_field_registrations_early_link[0]['rendered']))): ?>
...
<?php if (isset($fields['field_registrations_late_link']->content)): ?>
...
<?php if ((!empty($row->field_field_registrations_grp_cost[0]['rendered'])) || (!empty($row->field_field_registrations_grp_link[0]['rendered']))): ?>
<div class="regis-block-views-row regis-block-grp clearfix">
	<?php print render($fields['field_registrations_grp_title']->content); ?>
	<?php print render($fields['field_registrations_grp_cost']->content); ?>
	<?php print render($fields['field_registrations_grp_link']->content); ?>
</div>
<?php endif; ?>

<?php if ((!empty($row->field_field_registrations_vol_cost[0]['rendered'])) || (!empty($row->field_field_registrations_vol_link[0]['rendered']))): ?>
...
<?php if ((!empty($row->field_field_registrations_sch_cost[0]['rendered'])) || (!empty($row->field_field_registrations_sch_link[0]['rendered']))): ?>
...
<?php if ((!empty($row->field_field_registrations_stdnt_cost[0]['rendered'])) || (!empty($row->field_field_registrations_stdnt_link[0]['rendered']))): ?>
...
<?php if ((!empty($row->field_field_registrations_child_cost[0]['rendered'])) || (!empty($row->field_field_registrations_child_link[0]['rendered']))): ?>
<div class="regis-block-views-row regis-block-child clearfix">
	<?php print render($fields['field_registrations_child_title']->content); ?>
	<?php print render($fields['field_registrations_child_cost']->content); ?>
	<?php print render($fields['field_registrations_child_link']->content); ?>
</div>
<?php endif; ?>
