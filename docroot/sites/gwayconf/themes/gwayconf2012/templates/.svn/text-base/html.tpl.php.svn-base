...
<head<?php print $rdf->profile; ?>>
  ...
  <?php print $styles; ?>
	<noscript>
		<link rel="stylesheet" href="<?php print base_path(); ?>sites/all/themes/gatewayprototype/css/adapt_18/mobile.css" />
	</noscript>
	<script type="text/javascript">
		// Edit to suit your needs.
		var ADAPT_CONFIG = {
		  // Where is your CSS?
		  path: '<?php print base_path(); ?>sites/all/themes/gatewayprototype/css/adapt_18/',
