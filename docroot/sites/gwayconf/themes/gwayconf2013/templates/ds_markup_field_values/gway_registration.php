...
<?php if (!empty($entity->field_registrations_early_title) || !empty($entity->field_registrations_title) || !empty($entity->field_registrations_child_title)  || !empty($entity->field_registrations_stdnt_title)  || !empty($entity->field_registrations_vol_title) || !empty($entity->field_registrations_late_title) || !empty($entity->field_registrations_grp_title)): ?>
    ...
    <?php if (!empty($entity->field_registrations_early_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_early_sold['und'][0]['value']=='1'): print 'soldout'; else: print ''; endif; ?> clearfix">
    ...
    <?php if (!empty($entity->field_registrations_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_soldout['und'][0]['value']=='1'): print 'soldout'; ?><?php else: print ''; ?> <?php endif; ?> clearfix">
          <div class="registration-title">
    ...
    <?php if (!empty($entity->field_registrations_vol_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_vol_soldout['und'][0]['value']=='1'): print 'soldout'; ?><?php else: print ''; ?> <?php endif; ?> clearfix">
          <div class="registration-title">
    ...
    <?php if (!empty($entity->field_registrations_stdnt_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_stdnt_sold['und'][0]['value']=='1'): print 'soldout'; ?><?php else: print ''; ?> <?php endif; ?> clearfix">
          <div class="registration-title">
    ...
    <?php if (!empty($entity->field_registrations_grp_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_grp_soldout['und'][0]['value']=='1'): print 'soldout'; ?><?php else: print ''; ?> <?php endif; ?> clearfix">
          <div class="registration-title">
    ...
    <?php if (!empty($entity->field_registrations_late_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_late_soldout['und'][0]['value']=='1'): print 'soldout'; ?><?php else: print ''; ?> <?php endif; ?> clearfix">
          <div class="registration-title">
    ...
    <?php if (!empty($entity->field_registrations_child_title)): ?>
        <div class="registration-list-row regular-registration <?php if($entity->field_registrations_child_sold['und'][0]['value']=='1'): print 'soldout'; ?><?php else: print ''; ?> <?php endif; ?> clearfix">
          <div class="registration-title">
