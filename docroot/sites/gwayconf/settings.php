 ...
 *
 */
$drupal_hash_salt = 'YSBiQxiy9pv4uK1xaiScQTeticWo53hht8SwKbZalbI';
...
if (file_exists('/var/www/site-php')) {
      require('/var/www/site-php/gateway1/conference-settings.inc');
}
else if (file_exists(dirname(__FILE__) . '/local.settings.php')) {
